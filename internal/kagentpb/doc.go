...
// proofs send over gRPC-Web: kagent.api.v1alpha1's common.proto and
// agent_instances.proto (AgentInstanceService — create, get, list, delete an
// AgentInstance), generated with protoc-gen-go from the controller's own
// descriptor set. The turns themselves are lf.a2a.v1, taken from the A2A v1
...
//	  kagent/api/v1alpha1/common.proto kagent/api/v1alpha1/agent_instances.proto
//
