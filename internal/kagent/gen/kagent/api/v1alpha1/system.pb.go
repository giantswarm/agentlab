...
type SubstrateActorStatusCount struct {
	...
	State         gen.ActorState         `protobuf:"varint,3,opt,name=state,proto3,enum=ateapi.ActorState" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubstrateActorStatusCount) GetState() gen.ActorState {
	if x != nil {
		return x.State
	}
	return gen.ActorState(0)
}
...
type GetSubstrateSummaryResponse struct {
	...
	ActorTemplates []*gen.ActorTemplate `protobuf:"bytes,11,rep,name=actor_templates,json=actorTemplates,proto3" json:"actor_templates,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *GetSubstrateSummaryResponse) GetActorTemplates() []*gen.ActorTemplate {
	if x != nil {
...
type ListSubstrateActorsResponse struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	AteApiError string                 `protobuf:"bytes,2,opt,name=ate_api_error,json=ateApiError,proto3" json:"ate_api_error,omitempty"`
	Actors      []*gen.Actor           `protobuf:"bytes,3,rep,name=actors,proto3" json:"actors,omitempty"`
...
func (x *ListSubstrateActorsResponse) GetActors() []*gen.Actor {
	if x != nil {
		return x.Actors
	}
	return nil
...
type ListSubstrateWorkersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AteApiError   string                 `protobuf:"bytes,2,opt,name=ate_api_error,json=ateApiError,proto3" json:"ate_api_error,omitempty"`
	Workers       []*gen.Worker          `protobuf:"bytes,3,rep,name=workers,proto3" json:"workers,omitempty"`
	Page          *PageResponse          `protobuf:"bytes,4,opt,name=page,proto3" json:"page,omitempty"`
	ComputedAt    *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=computed_at,json=computedAt,proto3" json:"computed_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListSubstrateWorkersResponse) GetWorkers() []*gen.Worker {
	if x != nil {
		return x.Workers
	}
	return nil
...
const file_kagent_api_v1alpha1_system_proto_rawDesc = "" +
	...
	"\x14ListSubstrateWorkers\x120.kagent.api.v1alpha1.ListSubstrateWorkersRequest\x1a1.kagent.api.v1alpha1.ListSubstrateWorkersResponseB\xe8\x01\n" +
...
var file_kagent_api_v1alpha1_system_proto_goTypes = []any{
	...
	(gen.ActorState)(0),                  // 18: ateapi.ActorState
	(*timestamppb.Timestamp)(nil),        // 19: google.protobuf.Timestamp
	(*gen.ActorTemplate)(nil),            // 20: ateapi.ActorTemplate
	(*PageRequest)(nil),                  // 21: kagent.api.v1alpha1.PageRequest
	(*gen.Actor)(nil),                    // 22: ateapi.Actor
	(*PageResponse)(nil),                 // 23: kagent.api.v1alpha1.PageResponse
	(*gen.Worker)(nil),                   // 24: ateapi.Worker
}
